...
class IRTranslator{//中间代码的翻译器
    ...
    void nonRetFuncCallTranslator(IRStatement& statement,unsigned int beginloc);
    void retFuncCallTranslator(IRStatement& statement,unsigned int beginloc);
