...
class IRTranslator{//中间代码的翻译器
    ...
    unordered_map<string, bool> inlineFunctionMap;
    ...
    bool isInlineCrash(string& callee, string& caller, string& variable);
    bool inlineFunction(string& callee);
    ...
    bool isUserDefinitionVariable(string &variable, string &functionName);
