...
SymbolTableEntry* SymbolTable::syntaxParse_createVariableEntry(TokenType varType, string& varName, bool isConst) {
...
bool SymbolTable::syntaxParse_addVariableEntry(TokenType varType, SymbolName& varName, bool isConst) {
