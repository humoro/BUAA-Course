...
class SymbolTable{
    ...
    SymbolTableEntry* syntaxParse_createVariableEntry(TokenType varType, string& varName, bool isConst);
...
public:
    ...
    bool syntaxParse_addVariableEntry(TokenType varType, SymbolName& varName, bool isConst);
